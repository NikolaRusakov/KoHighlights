...
class Ui_About(object):
    ...
    def retranslateUi(self, About):
        self.about_tabs.setTabText(self.about_tabs.indexOf(self.info_tab), QtCore.QCoreApplication.translate("About", "Information", None))
        self.about_tabs.setTabText(self.about_tabs.indexOf(self.log_tab), QtCore.QCoreApplication.translate("About", "Log", None))
        self.about_qt_btn.setText(QtCore.QCoreApplication.translate("About", "About Qt", None))
        self.updates_btn.setToolTip(QtCore.QCoreApplication.translate("About", "Check online for an updated version", None))
        self.updates_btn.setText(QtCore.QCoreApplication.translate("About", "Check for Updates", None))
        self.close_btn.setText(QtCore.QCoreApplication.translate("About", "Close", None))
