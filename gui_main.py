...
class Ui_Base(object):
    ...
    def retranslateUi(self, Base):
        ...
        self.file_table.horizontalHeaderItem(0).setText(QtCore.QCoreApplication.translate("Base", "Title", None))
        self.file_table.horizontalHeaderItem(1).setText(QtCore.QCoreApplication.translate("Base", "Author", None))
        self.file_table.horizontalHeaderItem(2).setText(QtCore.QCoreApplication.translate("Base", "Type", None))
        self.file_table.horizontalHeaderItem(3).setText(QtCore.QCoreApplication.translate("Base", "Percent", None))
        self.file_table.horizontalHeaderItem(4).setText(QtCore.QCoreApplication.translate("Base", "Rating", None))
        self.file_table.horizontalHeaderItem(5).setText(QtCore.QCoreApplication.translate("Base", "Highlights", None))
        self.file_table.horizontalHeaderItem(6).setText(QtCore.QCoreApplication.translate("Base", "Modified", None))
        self.file_table.horizontalHeaderItem(7).setText(QtCore.QCoreApplication.translate("Base", "Path", None))
        self.fold_btn.setText(QtCore.QCoreApplication.translate("Base", "Hide Book Info", None))
        self.title_lbl.setText(QtCore.QCoreApplication.translate("Base", "Title", None))
        self.series_lbl.setText(QtCore.QCoreApplication.translate("Base", "Series", None))
        self.author_lbl.setText(QtCore.QCoreApplication.translate("Base", "Author", None))
        self.lang_lbl.setText(QtCore.QCoreApplication.translate("Base", "Language", None))
        self.pages_lbl.setText(QtCore.QCoreApplication.translate("Base", "Pages", None))
        self.tags_lbl.setText(QtCore.QCoreApplication.translate("Base", "Tags", None))
        self.description_btn.setText(QtCore.QCoreApplication.translate("Base", "Description", None))
        self.review_lbl.setText(QtCore.QCoreApplication.translate("Base", "Review", None))
        self.high_table.setSortingEnabled(True)
        self.high_table.horizontalHeaderItem(0).setText(QtCore.QCoreApplication.translate("Base", "Highlight", None))
        self.high_table.horizontalHeaderItem(1).setText(QtCore.QCoreApplication.translate("Base", "Comment", None))
        self.high_table.horizontalHeaderItem(2).setText(QtCore.QCoreApplication.translate("Base", "Date", None))
        self.high_table.horizontalHeaderItem(3).setText(QtCore.QCoreApplication.translate("Base", "Title", None))
        self.high_table.horizontalHeaderItem(4).setText(QtCore.QCoreApplication.translate("Base", "Author", None))
        self.high_table.horizontalHeaderItem(5).setText(QtCore.QCoreApplication.translate("Base", "Page", None))
        self.high_table.horizontalHeaderItem(6).setText(QtCore.QCoreApplication.translate("Base", "Chapter", None))
        self.high_table.horizontalHeaderItem(7).setText(QtCore.QCoreApplication.translate("Base", "Book path", None))
        self.act_english.setText(QtCore.QCoreApplication.translate("Base", "English", None))
        self.act_greek.setText(QtCore.QCoreApplication.translate("Base", "Greek", None))
        self.act_view_book.setText(QtCore.QCoreApplication.translate("Base", "View Book", None))
        self.act_view_book.setShortcut(QtCore.QCoreApplication.translate("Base", "Ctrl+B", None))
