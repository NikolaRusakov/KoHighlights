...
class Ui_ToolBar(object):
    def setupUi(self, ToolBar):
        ...
        self.check_btn = QtWidgets.QToolButton(self.tool_frame)
    ...
    def retranslateUi(self, ToolBar):
        self.scan_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Scans a directory for Koreader metadata files\n"
"Can also be the eReader\'s root directory (Ctrl+L)", None))
        self.scan_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Scans a directory for Koreader metadata files. Can also be the eReader\'s root directory (Ctrl+L)", None))
        self.scan_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Scan Directory", None))
        self.export_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Export selected highlights (Ctrl+S)", None))
        self.export_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Export selected highlights (Ctrl+S)", None))
        self.export_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Export", None))
        self.open_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "View the selected book (Ctrl+B)", None))
        self.open_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "View the selected book (Ctrl+B)", None))
        self.open_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "View", None))
        self.filter_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Open the filtering popup (Alt+F)", None))
        self.filter_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Open the filtering popup (Alt+F)", None))
        self.filter_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Filter", None))
        self.filter_btn.setShortcut(QtCore.QCoreApplication.translate("ToolBar", "Alt+F", None))
        self.merge_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Merge the highlights from the same book in two different\n"
"devices, and/or sync their reading position.\n"
"Activated only if two entries of the same book are selected.", None))
        self.merge_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Merge the highlights from the same book in two different devices, and/or sync their reading position. Activated only if two entries of the same book are selected.", None))
        self.merge_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Merge/Sync", None))
        self.delete_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Delete selected Highlights (Del)", None))
        self.delete_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Delete selected Highlights (Del)", None))
        self.delete_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Delete", None))
        self.clear_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Clears the books list (Ctrl+Backspace)", None))
        self.clear_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Clears the books list (Ctrl+Backspace)", None))
        self.clear_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Clear List", None))
        self.books_view_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Books View", None))
        self.books_view_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Books View", None))
        self.books_view_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Books", None))
        self.high_view_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Highlights View", None))
        self.high_view_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Highlights View", None))
        self.high_view_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Highlights", None))
        self.loaded_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Show the loaded files", None))
        self.loaded_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Show the loaded files", None))
        self.loaded_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Loaded", None))
        self.db_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Show the archived files in the database\n"
"(Right click for database actions menu)", None))
        self.db_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Show the archived files in the database (Right click for database actions menu)", None))
        self.db_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "Archived", None))
        self.about_btn.setToolTip(QtCore.QCoreApplication.translate("ToolBar", "Info about the KoHighlights (Ctrl+I)", None))
        self.about_btn.setStatusTip(QtCore.QCoreApplication.translate("ToolBar", "Info about the KoHighlights (Ctrl+I)", None))
        self.about_btn.setText(QtCore.QCoreApplication.translate("ToolBar", "About", None))
